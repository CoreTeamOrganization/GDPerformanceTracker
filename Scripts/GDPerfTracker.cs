...
internal struct PerfSummary
{
    ...
    internal Dictionary<string, object> ToPayload()
    {
        ...
        return new Dictionary<string, object>
        {
            ...
            { "fps_p01",        Mathf.RoundToInt(FpsP01) },
            { "fps_p05",        Mathf.RoundToInt(FpsP05) },
            { "fps_p25",        Mathf.RoundToInt(FpsP25) },
            { "fps_p50",        Mathf.RoundToInt(FpsP50) },
            { "fps_p75",        Mathf.RoundToInt(FpsP75) },
            { "fps_p95",        Mathf.RoundToInt(FpsP95) },
            { "fps_p99",        Mathf.RoundToInt(FpsP99) },
            { "worst_ms",       Mathf.RoundToInt(WorstFrameMs) },
            { "ram_total",      TotalDeviceRamMB },
            { "mem_alloc_peak", PeakAllocMB },
            { "mem_alloc_avg",  AvgAllocMB },
            { "mem_resv_peak",  PeakReservedMB },
            { "mem_resv_avg",   AvgReservedMB },
            { "mem_sys_peak",   PeakSystemMB },
            { "mem_sys_avg",    AvgSystemMB },
            { "seconds",        RecordedSeconds },
            { "tier_fps",       Application.targetFrameRate },
        };
    }
}
